...
Listy dostępu definiuje się przy pomocy komendy \mintinline{text}{access-list <nr_listy> permit <adres_ip> <wildcard>}. Przypisanie listy następuje przy pomocy route-mapy i użytego w niej polecenia  \mintinline{text}{match ip address <nr_listy>}, w mapie ustawia się również wartość metryki przy pomocy  \mintinline{text}{set metric <wartość>}, przy czym im mniejsza wartość, tym większy priorytet.
